...
data class AnalysisResult(
    ...
    val confidence: Int,
    val status: String,
    // 6.0 adds explicit geometry so diagnostics can distinguish a bad detector
    // from a bad trajectory calculation. Defaults preserve all older analyzers.
    val targetBall: Ball? = null,
    val aimDirection: Vec2? = null,
