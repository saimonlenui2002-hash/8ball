        ...
        return LinearLayout(this).apply {
            ...
            addView(text(
                "При системном запросе выберите «Одно приложение», затем игру. " +
                    "Начните захват до раздачи. В окне переключайте «Мои», «Бита», «Соперник» и «Стол». " +
                    "Если получатель стола не распознан, подтвердите его кнопками. Точный расчёт доступен только при полном учёте.",
                14f
